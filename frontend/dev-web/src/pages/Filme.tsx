...
import { FilmeInter, fetchFilmeById } from "../services/FilmesApi";
...
const Filme: React.FC = () => {
    ...
    const [filme, setFilme] = useState<FilmeInter>();
      ...
      return (
        <div className="media mb-4">
          ...
          <div className="media-body">
            <h5 className="mt-0">User</h5> {/* Placeholder for user name */}
    ...
    const Reviews: React.FC = () => {
      ...
      useEffect(() => {
        if (id !== undefined) {
          fetch('http://localhost:8080/avaliacoes/filmes?id='+id)  // Substitua pela URL da sua API
          .then(response => {
            if (!response.ok) {
        ...
        <div className="container mt-5">
          <div className="card">
            <div className="card-header">
              <h2>Avaliações de {filme?.nome ? filme.nome : 'Série'} </h2>
            </div>
