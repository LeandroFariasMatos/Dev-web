...
const Series: React.FC = () => {
    ...
    const [newSerie, setNewSerie] = useState<Partial<SerieInter>>({
        ...
        episodios: 0,
        categoria: '',
        dataDeLancamento: '' // Inicializa como string vazia
    });
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
        ...
        if (name === 'dataDeLancamento') {
            // Mantém o valor como string vazia se o usuário limpar o campo
            const formattedDate = value ? moment(value, 'YYYY-MM-DD').format('DD/MM/YYYY') : '';
